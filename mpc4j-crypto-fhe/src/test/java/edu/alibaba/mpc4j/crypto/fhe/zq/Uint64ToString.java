...
public class Uint64ToString {
    ...
    @Test
    public void nibbleToUpperHexTest() {
    ...
    public void uint64ToDecString() {
        ...
        number[0] = 0;
        number[1] = 1;
        // 0 * (2^64)^0 + 1 * (2^64)^1 = 2^64 =  18446744073709551616
