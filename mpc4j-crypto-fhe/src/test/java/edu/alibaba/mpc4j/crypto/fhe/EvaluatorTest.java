...
public class EvaluatorTest {
    ...
    public void bfvEncryptMultiplyPlainNTTDecrypt() {
        {
            ...
            // 明文转换为 Ntt
            evaluator.transformToNttInplace(plainMultiplier, context.getFirstParmsId());
            // 密文 * 明文
            evaluator.multiplyPlain(encrypted, plainMultiplier, encryptedDestination);
            // 密文转换回非 Ntt
            evaluator.transformFromNttInplace(encryptedDestination);
            // 解密
    ...
    public void bfvEncryptMultiplyPlainDecrypt() {
        ...
        // 参数4
        {
            ...
            encryptor.encrypt(plain, encrypted);
            evaluator.multiplyPlain(encrypted, plain, destination);
            decryptor.decrypt(destination, plain);
