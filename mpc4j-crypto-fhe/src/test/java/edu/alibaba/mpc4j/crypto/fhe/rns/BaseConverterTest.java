...
public class BaseConverterTest {
    ...
    public void convert() {
        ...
        bctTest(bct, new long[] {0}, new long[] {0});
        bctTest(bct, new long[] {2}, new long[] {0});
    ...
    public void exactConvertArray() {
        BaseConverter bct;
        bct = new BaseConverter(new RnsBase(new long[]{3}), new RnsBase(new long[]{2}));
        bctExactArrayTest(bct, new long[]{0, 1, 2}, new long[]{0, 1, 0});

        bct = new BaseConverter(new RnsBase(new long[]{2, 3}), new RnsBase(new long[]{2}));
        bctExactArrayTest(bct, new long[]{0, 1, 0, 0, 1, 2}, new long[]{0, 1, 0});
    }
    ...
    public void convertArray() {
        BaseConverter bct;
        bct = new BaseConverter(new RnsBase(new long[]{3}), new RnsBase(new long[]{2}));
        bctArrayTest(bct, new long[]{0, 1, 2}, new long[]{0, 1, 0});

        bct = new BaseConverter(new RnsBase(new long[]{2, 3}), new RnsBase(new long[]{2}));
        bctArrayTest(bct, new long[]{0, 1, 0, 0, 1, 2}, new long[]{0, 1, 0});

        bct = new BaseConverter(new RnsBase(new long[]{2, 3}), new RnsBase(new long[]{2, 3}));
        bctArrayTest(bct, new long[]{1, 1, 0, 1, 2, 2}, new long[]{1, 1, 0, 1, 2, 2});

        bct = new BaseConverter(new RnsBase(new long[]{2, 3}), new RnsBase(new long[]{3, 4, 5}));
        bctArrayTest(bct, new long[]{0, 1, 1, 0, 1, 2}, new long[]{0, 1, 2, 0, 3, 1, 0, 2, 0});
    }
}