...
public class GlobalVariables {
    ...
    static {
        /*
           ...
           ` Modulus count: 1
             Total bit count: 27`
         */
        DEFAULT_COEFF_MUDULUS_128.put(1024, Modulus.createModulus(new long[]{0x7e00001L}));
          /*
              Polynomial modulus: 1x^2048 + 1
              Modulus count: 1
              Total bit count: 54
         */
        DEFAULT_COEFF_MUDULUS_128.put(2048, Modulus.createModulus(new long[]{0x3fffffff000001L}));
        /*
             Polynomial modulus: 1x^4096 + 1
             Modulus count: 3
             Total bit count: 109 = 2 * 36 + 37
         */
        DEFAULT_COEFF_MUDULUS_128.put(4096, Modulus.createModulus(new long[]{0xffffee001L, 0xffffc4001L, 0x1ffffe0001L}));
        /*
            Polynomial modulus: 1x^8192 + 1
            Modulus count: 5
            Total bit count: 218 = 2 * 43 + 3 * 44
         */
        DEFAULT_COEFF_MUDULUS_128.put(8192, Modulus.createModulus(new long[]{0x7fffffd8001L, 0x7fffffc8001L, 0xfffffffc001L, 0xffffff6c001L, 0xfffffebc001L}));
        /*
    ...
    public static final Map<Integer, Modulus[]> DEFAULT_COEFF_MUDULUS_192 = new HashMap<>();
    ...
    static {
        /*
            ...
            Total bit count: 19
         */
        DEFAULT_COEFF_MUDULUS_192.put(1024, Modulus.createModulus(new long[]{0x7f001L}));
          /*
            Polynomial modulus: 1x^2048 + 1
            Modulus count: 1
            Total bit count: 37
         */
        DEFAULT_COEFF_MUDULUS_192.put(2048, Modulus.createModulus(new long[]{0x1ffffc0001L}));
        /*
            Polynomial modulus: 1x^4096 + 1
            Modulus count: 3
            Total bit count: 75 = 3 * 25
         */
        DEFAULT_COEFF_MUDULUS_192.put(4096, Modulus.createModulus(new long[]{0x1ffc001L, 0x1fce001L, 0x1fc0001L}));
        /*
            Polynomial modulus: 1x^8192 + 1
            Modulus count: 4
            Total bit count: 152 = 4 * 38
         */
        DEFAULT_COEFF_MUDULUS_192.put(8192, Modulus.createModulus(new long[]{0x3ffffac001L, 0x3ffff54001L, 0x3ffff48001L, 0x3ffff28001L}));
        /*
            Polynomial modulus: 1x^16384 + 1
            Modulus count: 6
    ...
    public static final Map<Integer, Modulus[]> DEFAULT_COEFF_MUDULUS_256 = new HashMap<>();
    ...
    static {
        /*
            ...
            Total bit count: 14
         */
        DEFAULT_COEFF_MUDULUS_256.put(1024, Modulus.createModulus(new long[]{0x3001L}));
          /*
            Polynomial modulus: 1x^2048 + 1
            Modulus count: 1
            Total bit count: 29
         */
        DEFAULT_COEFF_MUDULUS_256.put(2048, Modulus.createModulus(new long[]{0x1ffc0001L}));
        /*
            Polynomial modulus: 1x^4096 + 1
            Modulus count: 1
            Total bit count: 58
         */
        DEFAULT_COEFF_MUDULUS_256.put(4096, Modulus.createModulus(new long[]{0x3ffffffff040001L}));
        /*
            Polynomial modulus: 1x^8192 + 1
            Modulus count: 3
            Total bit count: 118 = 2 * 39 + 40
         */
        DEFAULT_COEFF_MUDULUS_256.put(8192, Modulus.createModulus(new long[]{0x7ffffec001L, 0x7ffffb0001L, 0xfffffdc001L}));
        /*
            Polynomial modulus: 1x^16384 + 1
            Modulus count: 5
