...
public class UintArithmeticSmallMod {
    ...
    public static long moduloUint(long[] operand, int startIndex, int uint64Count, Modulus modulus) {
        ...
        if (uint64Count == 1) {
            if (operand[startIndex] < modulus.getValue()) {
    ...
    public static long multiplyUintMod(long operand1, MultiplyUintModOperand operand2, Modulus modulus) {
        assert operand2.operand < modulus.getValue() : "y: " + operand2.operand + ", modulus: " + modulus.getValue();
    ...
    public static long multiplyUintModLazy(long operand1, MultiplyUintModOperand operand2, Modulus modulus) {
        assert operand2.operand < modulus.getValue();
    ...
    public static long barrettReduce64(long operand, Modulus modulus) {
        ...
        long q = UintArithmetic.multiplyUint64Hw64(operand, modulus.getConstRatio()[1]);
        long res = operand - q * modulus.getValue();
    ...
    public static long barrettReduce128(long[] operand, Modulus modulus) {
        ...
        carry = UintArithmetic.multiplyUint64Hw64(operand[0], modulus.getConstRatio()[0]);
        // tmp2 = [(x0 * m1)_0, (x0 * m1)_1]
        UintArithmetic.multiplyUint64(operand[0], modulus.getConstRatio()[1], tmp2);
        ...
        UintArithmetic.multiplyUint64(operand[1], modulus.getConstRatio()[0], tmp2);
        ...
        tmp1 = operand[1] * modulus.getConstRatio()[1] + tmp3 + carry;
        // reduction
        tmp3 = operand[0] - tmp1 * modulus.getValue();
    ...
    public static long addUintMod(long operand1, long operand2, Modulus modulus) {
        assert !modulus.isZero();
        assert Long.compareUnsigned(operand1 + operand2, modulus.getValue() << 1) < 0;
        // Sum of a + b modulo Modulus can never wrap around 2^64
        operand1 += operand2;
        return operand1 >= modulus.getValue() ? operand1 - modulus.getValue() : operand1;
    }
    ...
    public static long subUintMod(long operand1, long operand2, Modulus modulus) {
        assert !modulus.isZero();
        assert Long.compareUnsigned(operand1, modulus.getValue()) < 0;
        assert Long.compareUnsigned(operand2, modulus.getValue()) < 0;
