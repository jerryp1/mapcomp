...
import edu.alibaba.mpc4j.s2pc.opf.oprf.prty19.Prty19LowMpOprfConfig;
...
public class Prty19LowPsiConfig extends AbstractMultiPartyPtoConfig implements PsiConfig {
    ...
    public PsiFactory.PsiType getPtoType() {
        return PsiFactory.PsiType.PRTY19_LOW;
    }
    ...
    public static class Builder implements org.apache.commons.lang3.builder.Builder<Prty19LowPsiConfig> {
        ...
        public Builder() {
            mpOprfConfig = new Prty19LowMpOprfConfig.Builder().build();
        ...
        public Builder setOkvsType(Gf2eDokvsType okvsType) {
            return setMpOprfConfig(new Prty19LowMpOprfConfig.Builder().setOkvsType(okvsType).build());
        }
