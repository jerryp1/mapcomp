...
public class Psz14GbfPsiServer <T> extends AbstractPsiServer<T> {
    /**
     * OPRF发送方
     */
    ...
    public Psz14GbfPsiServer(Rpc serverRpc, Party clientParty, Psz14GbfPsiConfig config) {
        super(Psz14GbfPsiPtoDesc.getInstance(), serverRpc, clientParty, config);
