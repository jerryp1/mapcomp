...
/**
 * payload psi main for a batch
 *
 * @author Feng Han
 * @date 2023/11/24
 */
public class PlpsiMain4Batch {
    private static final Logger LOGGER = LoggerFactory.getLogger(PlpsiMain4Batch.class);
    /**
     * protocol type name
     */
    ...
    public PlpsiMain4Batch(Properties properties) {
