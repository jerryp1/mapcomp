package edu.alibaba.mpc4j.s2pc.pso.opprf.rbopprf.cgs22;
...
import edu.alibaba.mpc4j.s2pc.pso.opprf.rbopprf.cgs22.Cgs22RbopprfPtoDesc.PtoStep;
import edu.alibaba.mpc4j.s2pc.pso.opprf.rbopprf.AbstractRbopprfSender;
        ...
        while (!success) {
            try {
                ...
                cuckooHashTable = CuckooHashBinFactory.createCuckooHashBin(
                    envType, CuckooHashBinFactory.CuckooHashBinType.NO_STASH_PSZ18_3_HASH, pointNum, garbledTableKeys
                );
