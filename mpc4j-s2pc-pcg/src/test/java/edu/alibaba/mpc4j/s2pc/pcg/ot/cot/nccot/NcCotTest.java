...
import edu.alibaba.mpc4j.s2pc.pcg.ot.cot.nccot.NcCotFactory.NcCotType;
...
public class NcCotTest {
    ...
    public static Collection<Object[]> configurations() {
        ...
        configurations.add(new Object[] {
            NcCotType.NAIVE.name() + " (" + SecurityModel.MALICIOUS + ")",
            new NaiveNcCotConfig.Builder(SecurityModel.MALICIOUS).build(),
        });
        // NAIVE (Semi-honest)
        configurations.add(new Object[] {
            NcCotType.NAIVE.name() + " (" + SecurityModel.SEMI_HONEST + ")",
            new NaiveNcCotConfig.Builder(SecurityModel.SEMI_HONEST).build(),
        });
