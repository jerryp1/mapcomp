...
import edu.alibaba.mpc4j.s2pc.pcg.ot.cot.rcot.AbstractRcotReceiver;
import edu.alibaba.mpc4j.s2pc.pcg.ot.cot.CotReceiverOutput;
import edu.alibaba.mpc4j.s2pc.pcg.ot.cot.rcot.iknp03.Iknp03RcotPtoDesc.PtoStep;

/**
 * IKNP03-半诚实安全RCOT协议接收方。
 *
 * @author Weiran Liu
 * @date 2020/05/27
 */
public class Iknp03RcotReceiver extends AbstractRcotReceiver {
    /**
     * 基础OT协议发送方
     */
    ...
    public Iknp03RcotReceiver(Rpc receiverRpc, Party senderParty, Iknp03RcotConfig config) {
        super(Iknp03RcotPtoDesc.getInstance(), receiverRpc, senderParty, config);
