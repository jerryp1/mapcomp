...
import edu.alibaba.mpc4j.s2pc.pcg.vole.zp.vole.AbstractZpVoleReceiver;
import edu.alibaba.mpc4j.s2pc.pcg.vole.zp.vole.ZpVoleReceiverOutput;
import edu.alibaba.mpc4j.s2pc.pcg.vole.zp.vole.kos16.Kos16ShZpVolePtoDesc.PtoStep;
 ...
 * @date 2022/06/09
 */
public class Kos16ShZpVoleReceiver extends AbstractZpVoleReceiver {
    /**
     * 基础OT协议接收方
     */
    ...
    public Kos16ShZpVoleReceiver(Rpc senderRpc, Party receiverParty, Kos16ShZpVoleConfig config) {
        super(Kos16ShZpVolePtoDesc.getInstance(), senderRpc, receiverParty, config);
