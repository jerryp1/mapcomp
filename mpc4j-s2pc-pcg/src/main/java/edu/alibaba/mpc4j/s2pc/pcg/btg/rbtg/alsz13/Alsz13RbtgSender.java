 ...
 * @date 2022/4/6
 */
public class Alsz13RbtgSender extends AbstractRbtgParty {
    /**
     * NC-COT协议发送方
     */
    ...
    public Alsz13RbtgSender(Rpc senderRpc, Party receiverParty, Alsz13RbtgConfig config) {
        super(Alsz13RbtgPtoDesc.getInstance(), senderRpc, receiverParty, config);
