 ...
 * @date 2022/7/13
 */
public abstract class AbstractRbtgParty extends AbstractSecureTwoPartyPto implements RbtgParty {
    /**
     * 配置项
     */
    protected final RbtgConfig config;
    /**
     * 最大数量
     */
    ...
    public AbstractRbtgParty(PtoDesc ptoDesc, Rpc ownRpc, Party otherParty, RbtgConfig config) {
