 ...
 * @date 2022/4/6
 */
class Alsz13RootZ2MtgPtoDesc implements PtoDesc {
    /**
     * 协议ID
     */
     ...
     * 协议名称
     */
    private static final String PTO_NAME = "ALSZ13_ROOT_Z2_MTG";

    /**
     * 单例模式
     */
    private static final Alsz13RootZ2MtgPtoDesc INSTANCE = new Alsz13RootZ2MtgPtoDesc();

    /**
     * 私有构造函数
     */
    private Alsz13RootZ2MtgPtoDesc() {
        // empty
    }
