 ...
 * @date 2020/08/13
 */
class Iknp03RcotPtoDesc implements PtoDesc {
    /**
     * 协议ID
     */
     ...
     * 协议名称
     */
    private static final String PTO_NAME = "IKNP03_RCOT";
     ...
     * 单例模式
     */
    private static final Iknp03RcotPtoDesc INSTANCE = new Iknp03RcotPtoDesc();

    /**
     * 私有构造函数
     */
    private Iknp03RcotPtoDesc() {
        // empty
    }
