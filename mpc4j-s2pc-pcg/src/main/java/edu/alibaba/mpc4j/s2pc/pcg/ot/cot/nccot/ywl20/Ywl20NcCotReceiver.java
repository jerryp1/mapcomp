...
import edu.alibaba.mpc4j.s2pc.pcg.ot.cot.nccot.ywl20.Ywl20NcCotPtoDesc.PtoStep;
...
import edu.alibaba.mpc4j.s2pc.pcg.ot.cot.spcot.mspcot.MspCotReceiver;
import edu.alibaba.mpc4j.s2pc.pcg.ot.cot.spcot.mspcot.MspCotReceiverOutput;
...
public class Ywl20NcCotReceiver extends AbstractNcCotReceiver {
    ...
    public void setTaskId(long taskId) {
        ...
        rcotReceiver.setTaskId(taskIdPrf.getLong(0, taskIdBytes, Long.MAX_VALUE));
    ...
    public void init(int num) throws MpcAbortException {
        ...
        CotReceiverOutput wInitCotReceiverOutput = rcotReceiver.receive(choices);
        stopWatch.stop();
        ...
        rCotPreSize = MspCotFactory.getPrecomputeNum(mspCotConfig, iterationT, iterationN);
        rCotReceiverOutput.reduce(rCotPreSize);
        stopWatch.stop();
    ...
    public CotReceiverOutput receive() throws MpcAbortException {
        ...
        rCotReceiverOutput = receiverOutput.split(rCotPreSize);
