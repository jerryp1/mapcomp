...
import edu.alibaba.mpc4j.s2pc.pcg.vole.zp64.vole.AbstractZp64VoleReceiver;
 ...
 * @date 2022/06/09
 */
public class Kos16ShZp64VoleReceiver extends AbstractZp64VoleReceiver {
    /**
     * 基础OT协议接收方
     */
    ...
    public Kos16ShZp64VoleReceiver(Rpc receiverRpc, Party senderParty, Kos16ShZp64VoleConfig config) {
        super(Kos16ShZp64VolePtoDesc.getInstance(), receiverRpc, senderParty, config);
    ...
    public void init(long prime, long delta, int maxNum) throws MpcAbortException {
        ...
        l = zp64.getL();
        baseOtReceiver.init();
        deltaBinary = gadget.decomposition(delta);
    ...
    public Zp64VoleReceiverOutput receive(int num) throws MpcAbortException {
        ...
        DataPacketHeader matrixHeader = new DataPacketHeader(
                taskId, getPtoDesc().getPtoId(), Kos16ShZp64VolePtoDesc.PtoStep.RECEIVER_SEND_MATRIX.ordinal(), extraInfo,
    ...
    private Zp64VoleReceiverOutput handleMatrixPayload(List<byte[]> matrixPayload) throws MpcAbortException {
        ...
        long[] q = qMatrixStream
                .mapToLong(row -> gadget.composition(row))
                .toArray();
