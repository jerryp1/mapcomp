...
public class Ywl20MaBspCotReceiver extends AbstractBspCotReceiver {
    ...
    private BspCotReceiverOutput receive() throws MpcAbortException {
        ...
        int dpprfCotNum = Gf2kDpprfFactory.getPrecomputeNum(gf2kDpprfConfig, batchNum, num);
        ...
        stopWatch.start();
        Gf2kDpprfReceiverOutput gf2kDpprfReceiverOutput = gf2kDpprfReceiver.puncture(alphaArray, num, extendCotReceiverOutput);
        stopWatch.stop();
