...
public class BooleanTriple {
     ...
     * @param c   随机分量c。
     */
    public static BooleanTriple create(int num, byte[] a, byte[] b, byte[] c) {
        ...
        BooleanTriple triple = new BooleanTriple();
        triple.num = num;
     ...
     */
    public static BooleanTriple createEmpty() {
        BooleanTriple emptyTriple = new BooleanTriple();
        emptyTriple.num = 0;
     ...
     * @param c   随机分量c。
     */
    private static BooleanTriple create(int num, BigInteger a, BigInteger b, BigInteger c) {
        assert num > 0 : "num must be greater than 0";
        ...
        BooleanTriple booleanTriple = new BooleanTriple();
     ...
     * @param length 指定切分长度。
     */
    public BooleanTriple split(int length) {
        ...
        // 返回切分出的布尔三元组
        return BooleanTriple.create(length, splitA, spiltB, splitC);
    }
     ...
     * @param that 另一个布尔三元组。
     */
    public void merge(BooleanTriple that) {
        // 移位
