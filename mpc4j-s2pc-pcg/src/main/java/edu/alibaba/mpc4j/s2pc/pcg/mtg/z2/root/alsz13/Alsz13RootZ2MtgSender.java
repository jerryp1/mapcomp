 ...
 * @date 2022/4/6
 */
public class Alsz13RootZ2MtgSender extends AbstractRootZ2MtgParty {
    /**
     * NC-COT协议发送方
     */
    ...
    public Alsz13RootZ2MtgSender(Rpc senderRpc, Party receiverParty, Alsz13RootZ2MtgConfig config) {
        super(Alsz13RootZ2MtgPtoDesc.getInstance(), senderRpc, receiverParty, config);
