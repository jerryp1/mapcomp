...
import edu.alibaba.mpc4j.s2pc.pcg.vole.zp64.vole.AbstractZp64VoleSender;
 ...
 * @date 2022/06/09
 */
public class Kos16ShZp64VoleSender extends AbstractZp64VoleSender {
    /**
     * 基础OT协议发送方
     */
    ...
    public Kos16ShZp64VoleSender(Rpc senderRpc, Party receiverParty, Kos16ShZp64VoleConfig config) {
        super(Kos16ShZp64VolePtoDesc.getInstance(), senderRpc, receiverParty, config);
    ...
    private Zp64VoleSenderOutput generateSenderOutput() {
        ...
        long[] t = outputStream
                .mapToLong(index -> zp64.neg(gadget.composition(t0[index])))
                .toArray();
