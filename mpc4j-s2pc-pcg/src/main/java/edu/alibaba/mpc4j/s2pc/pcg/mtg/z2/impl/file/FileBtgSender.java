 ...
 * @date 2022/5/22
 */
public class FileBtgSender extends AbstractZ2MtgParty {
    /**
     * 文件名分隔符
     */
    ...
    public FileBtgSender(Rpc senderRpc, Party receiverParty, FileZ2MtgConfig config) {
    ...
    public void init(int maxRoundNum, int updateNum) throws MpcAbortException {
        ...
        try {
            ...
            booleanTriple = Z2Triple.create(updateNum, a0, b0, c0);
    ...
    public Z2Triple generate(int num) throws MpcAbortException {
        ...
        stopWatch.start();
        Z2Triple senderOutput = booleanTriple.split(num);
        stopWatch.stop();
