 ...
 * @date 2021/12/26
 */
public abstract class AbstractRcotSender extends AbstractSecureTwoPartyPto implements RcotSender {
    /**
     * 配置项
     */
    ...
    protected AbstractRcotSender(PtoDesc ptoDesc, Rpc senderRpc, Party receiverParty, RcotConfig config) {
