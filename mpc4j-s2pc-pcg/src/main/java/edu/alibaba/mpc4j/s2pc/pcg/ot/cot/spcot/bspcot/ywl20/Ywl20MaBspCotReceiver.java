...
import edu.alibaba.mpc4j.s2pc.pcg.ot.cot.spcot.bspcot.AbstractBspCotReceiver;
...
import edu.alibaba.mpc4j.s2pc.pcg.ot.cot.spcot.bspcot.ywl20.Ywl20MaBspCotPtoDesc.PtoStep;
...
public class Ywl20MaBspCotReceiver extends AbstractBspCotReceiver {
    ...
    public void init( int maxBatch, int maxNum) throws MpcAbortException {
        ...
        rcotReceiver.init(maxH * maxBatch + CommonConstants.BLOCK_BIT_LENGTH);
        stopWatch.stop();
    ...
    private BspCotReceiverOutput receive() throws MpcAbortException {
        ...
        if (cotReceiverOutput == null) {
            ...
            cotReceiverOutput = rcotReceiver.receive(rs);
        } else {
