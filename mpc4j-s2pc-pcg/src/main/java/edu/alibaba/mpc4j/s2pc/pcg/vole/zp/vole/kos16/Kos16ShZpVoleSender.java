...
import edu.alibaba.mpc4j.s2pc.pcg.vole.zp.vole.AbstractZpVoleSender;
 ...
 * @date 2022/06/09
 */
public class Kos16ShZpVoleSender extends AbstractZpVoleSender {
    /**
     * 基础OT协议发送方
     */
    ...
    public Kos16ShZpVoleSender(Rpc receiverRpc, Party senderParty, Kos16ShZpVoleConfig config) {
        super(Kos16ShZpVolePtoDesc.getInstance(), receiverRpc, senderParty, config);
    ...
    public ZpVoleSenderOutput send(BigInteger[] x) throws MpcAbortException {
        ...
        DataPacketHeader matrixHeader = new DataPacketHeader(
            taskId, getPtoDesc().getPtoId(), Kos16ShZpVolePtoDesc.PtoStep.RECEIVER_SEND_MATRIX.ordinal(), extraInfo,
