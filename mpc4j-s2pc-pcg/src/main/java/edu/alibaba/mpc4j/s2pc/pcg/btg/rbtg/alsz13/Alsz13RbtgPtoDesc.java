 ...
 * @date 2022/4/6
 */
class Alsz13RbtgPtoDesc implements PtoDesc {
    /**
     * 协议ID
     */
     ...
     * 协议名称
     */
    private static final String PTO_NAME = "ALSZ13_RBTG";

    /**
     * 单例模式
     */
    private static final Alsz13RbtgPtoDesc INSTANCE = new Alsz13RbtgPtoDesc();

    /**
     * 私有构造函数
     */
    private Alsz13RbtgPtoDesc() {
        // empty
    }
