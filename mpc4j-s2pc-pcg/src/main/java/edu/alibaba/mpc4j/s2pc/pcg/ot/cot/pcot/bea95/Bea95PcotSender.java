...
import edu.alibaba.mpc4j.s2pc.pcg.ot.cot.pcot.AbstractPcotSender;
 ...
 * @date 2022/01/14
 */
public class Bea95PcotSender extends AbstractPcotSender {

    public Bea95PcotSender(Rpc senderRpc, Party receiverParty, Bea95PcotConfig config) {
        super(Bea95PcotPtoDesc.getInstance(), senderRpc, receiverParty, config);
    }
