 ...
 * @date 2022/4/6
 */
public class Alsz13RbtgReceiver extends AbstractRbtgParty {
    /**
     * NC-COT协议接收方
     */
    ...
    public Alsz13RbtgReceiver(Rpc receiverRpc, Party senderParty, Alsz13RbtgConfig config) {
        super(Alsz13RbtgPtoDesc.getInstance(), receiverRpc, senderParty, config);
