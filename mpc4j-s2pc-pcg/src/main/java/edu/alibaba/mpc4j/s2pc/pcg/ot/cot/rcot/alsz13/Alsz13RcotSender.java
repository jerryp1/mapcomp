...
import edu.alibaba.mpc4j.s2pc.pcg.ot.cot.rcot.AbstractRcotSender;
import edu.alibaba.mpc4j.s2pc.pcg.ot.cot.CotSenderOutput;

/**
 * ALSZ13-半诚实安全RCOT协议发送方。
 *
 * @author Weiran Liu
 * @date 2020/06/02
 */
public class Alsz13RcotSender extends AbstractRcotSender {
    /**
     * 基础OT协议接收方
     */
    ...
    public Alsz13RcotSender(Rpc senderRpc, Party receiverParty, Alsz13RcotConfig config) {
        super(Alsz13RcotPtoDesc.getInstance(), senderRpc, receiverParty, config);
    ...
    public CotSenderOutput send(int num) throws MpcAbortException {
        ...
        DataPacketHeader matrixHeader = new DataPacketHeader(
            taskId, getPtoDesc().getPtoId(), Alsz13RcotPtoDesc.PtoStep.RECEIVER_SEND_MATRIX.ordinal(), extraInfo,
    ...
    private CotSenderOutput handleMatrixPayload(List<byte[]> matrixPayload) throws MpcAbortException {
        ...
        // 定义并设置矩阵Q
        BitMatrix qMatrix = BitMatrixFactory.createInstance(envType, num, CommonConstants.BLOCK_BIT_LENGTH, parallel);
        // 设置矩阵Q的每一列
