 ...
 * @date 2022/06/08
 */
public class Kos16ShZpVolePtoDesc implements PtoDesc {
    /**
     * 协议ID。
     */
     ...
     * 协议名称。
     */
    private static final String PTO_NAME = "KOS16_SH_ZP_VOLE";
     ...
     * 单例模式。
     */
    private static final Kos16ShZpVolePtoDesc INSTANCE = new Kos16ShZpVolePtoDesc();

    /**
     * 私有构造函数。
     */
    private Kos16ShZpVolePtoDesc() {
        // empty
    }
