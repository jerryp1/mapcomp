 ...
 * @date 2022/4/6
 */
public class Alsz13RootZ2MtgReceiver extends AbstractRootZ2MtgParty {
    /**
     * NC-COT协议接收方
     */
    ...
    public Alsz13RootZ2MtgReceiver(Rpc receiverRpc, Party senderParty, Alsz13RootZ2MtgConfig config) {
        super(Alsz13RootZ2MtgPtoDesc.getInstance(), receiverRpc, senderParty, config);
