...
import edu.alibaba.mpc4j.s2pc.pcg.ot.cot.spcot.sspcot.AbstractSspCotSender;
...
public class Ywl20MaSspCotSender extends AbstractSspCotSender {
    ...
    public void init(byte[] delta, int maxNum) throws MpcAbortException {
        ...
        rcotSender.init(delta, maxH + CommonConstants.BLOCK_BIT_LENGTH);
        stopWatch.stop();
    ...
    private SspCotSenderOutput send() throws MpcAbortException {
        ...
        if (cotSenderOutput == null) {
            cotSenderOutput = rcotSender.send(h + CommonConstants.BLOCK_BIT_LENGTH);
        } else {
