 ...
 * @date 2022/5/22
 */
public class FileBtgReceiver extends AbstractBtgParty {
    /**
     * 文件名分隔符
     */
    ...
    public FileBtgReceiver(Rpc receiverRpc, Party senderParty, FileBtgConfig config) {
    ...
    public void init(int maxRoundNum, int updateNum) throws MpcAbortException {
        ...
        try {
            ...
            booleanTriple = BooleanTriple.create(updateNum, a1, b1, c1);
    ...
    public BooleanTriple generate(int num) throws MpcAbortException {
        ...
        stopWatch.start();
        BooleanTriple receiverOutput = booleanTriple.split(num);
        stopWatch.stop();
