...
import edu.alibaba.mpc4j.s2pc.pcg.btg.rbtg.AbstractRbtgParty;
 ...
 * @date 2022/02/08
 */
public class IdealRbtgReceiver extends AbstractRbtgParty {
    /**
     * 密钥派生函数
     */
    ...
    public IdealRbtgReceiver(Rpc receiverRpc, Party senderParty, IdealRbtgConfig config) {
        super(IdealRbtgPtoDesc.getInstance(), receiverRpc, senderParty, config);
    ...
    public void init(int maxNum) throws MpcAbortException {
        ...
        DataPacketHeader rootKeyHeader = new DataPacketHeader(
            taskId, getPtoDesc().getPtoId(), IdealRbtgPtoDesc.PtoStep.SERVER_SEND_ROOT_KEY.ordinal(), extraInfo,
    ...
    public BooleanTriple generate(int num) throws MpcAbortException {
        ...
        stopWatch.start();
        BooleanTriple receiverOutput = generateBooleanTriple();
        stopWatch.stop();
    ...
    private BooleanTriple generateBooleanTriple() {
        ...
        return BooleanTriple.create(num, a1, b1, c1);
    }
}
