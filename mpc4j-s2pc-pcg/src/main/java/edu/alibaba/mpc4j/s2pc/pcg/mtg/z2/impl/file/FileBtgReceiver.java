 ...
 * @date 2022/5/22
 */
public class FileBtgReceiver extends AbstractZ2MtgParty {
    /**
     * 文件名分隔符
     */
     ...
     * 布尔三元组
     */
    private Z2Triple booleanTriple;

    public FileBtgReceiver(Rpc receiverRpc, Party senderParty, FileZ2MtgConfig config) {
        super(FileBtgPtoDesc.getInstance(), receiverRpc, senderParty, config);
    ...
    public void init(int maxRoundNum, int updateNum) throws MpcAbortException {
        ...
        stopWatch.start();
        String receiverBtgFileName = getFileName();
        File receiverBtgFile = new File(filePath + File.separator + receiverBtgFileName);
        if (!receiverBtgFile.exists()) {
            // 如果没有文件，则生成
            ...
            try {
                FileWriter fileWriter = new FileWriter(receiverBtgFile);
                ...
                e.printStackTrace();
                throw new IllegalStateException("Cannot write data into file " + receiverBtgFile.getAbsolutePath());
            }
        }
        stopWatch.stop();
        ...
        try {
            ...
            InputStreamReader inputStreamReader = new InputStreamReader(
                new FileInputStream(receiverBtgFile), StandardCharsets.UTF_8
            );
            ...
            booleanTriple = Z2Triple.create(updateNum, a1, b1, c1);
            ...
            e.printStackTrace();
            throw new IllegalStateException("Cannot read data from file " + receiverBtgFile.getAbsolutePath());
        }
        initialized = true;
    ...
    public Z2Triple generate(int num) throws MpcAbortException {
        ...
        stopWatch.start();
        Z2Triple receiverOutput = booleanTriple.split(num);
        stopWatch.stop();
