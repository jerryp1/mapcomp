...
import edu.alibaba.mpc4j.s2pc.pcg.mtg.z2.root.AbstractRootZ2MtgParty;
 ...
 * @date 2022/02/08
 */
public class IdealRootZ2MtgReceiver extends AbstractRootZ2MtgParty {
    /**
     * 密钥派生函数
     */
    ...
    public IdealRootZ2MtgReceiver(Rpc receiverRpc, Party senderParty, IdealRootZ2MtgConfig config) {
        super(IdealRootZ2MtgPtoDesc.getInstance(), receiverRpc, senderParty, config);
    ...
    public void init(int maxNum) throws MpcAbortException {
        ...
        DataPacketHeader rootKeyHeader = new DataPacketHeader(
            taskId, getPtoDesc().getPtoId(), IdealRootZ2MtgPtoDesc.PtoStep.SERVER_SEND_ROOT_KEY.ordinal(), extraInfo,
