 ...
 * @date 2022/02/08
 */
public class IdealRootZ2MtgSender extends AbstractRootZ2MtgParty {
    /**
     * 密钥派生函数
     */
    ...
    public IdealRootZ2MtgSender(Rpc senderRpc, Party receiverParty, IdealRootZ2MtgConfig config) {
        super(IdealRootZ2MtgPtoDesc.getInstance(), senderRpc, receiverParty, config);
