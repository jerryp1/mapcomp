...
import edu.alibaba.mpc4j.s2pc.pcg.ot.lo.nc.direct.DirectNcLotConfig;
import edu.alibaba.mpc4j.s2pc.pcg.ot.lo.nc.direct.DirectNcLotReceiver;
import edu.alibaba.mpc4j.s2pc.pcg.ot.lo.nc.direct.DirectNcLotSender;
...
public class NcLotFactory {
    ...
    public static NcLotSender createSender(Rpc senderRpc, Party receiverParty, NcLotConfig config) {
        ...
        switch (type) {
            ...
            case VOLELOT:
            default:
                throw new IllegalArgumentException("Invalid NcLotType: " + type.name());
        }
    }
