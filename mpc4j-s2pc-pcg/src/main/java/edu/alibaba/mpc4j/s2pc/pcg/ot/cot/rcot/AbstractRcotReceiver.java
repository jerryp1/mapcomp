 ...
 * @date 2021/12/26
 */
public abstract class AbstractRcotReceiver extends AbstractSecureTwoPartyPto implements RcotReceiver {
    /**
     * 配置项
     */
    ...
    protected AbstractRcotReceiver(PtoDesc ptoDesc, Rpc receiverRpc, Party senderParty, RcotConfig config) {
