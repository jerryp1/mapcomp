...
import edu.alibaba.mpc4j.s2pc.pcg.ot.cot.rcot.alsz13.Alsz13RcotPtoDesc.PtoStep;

/**
 * ALSZ13-半诚实安全RCOT协议接收方。
 *
 * @author Weiran Liu
 * @date 2020/06/02
 */
public class Alsz13RcotReceiver extends AbstractRcotReceiver {
    /**
     * 基础OT协议发送方
     */
