 ...
 * @date 2023/11/21
 */
public class HardcodeB2aTupleReceiver extends AbstractB2aTupleParty {

    public HardcodeB2aTupleReceiver(Rpc receiverRpc, Party senderParty, HardcodeB2aTupleConfig config) {
        super(HardcodeB2aTuplePtoDesc.getInstance(), receiverRpc, senderParty, config);
    }

    public HardcodeB2aTupleReceiver(Rpc receiverRpc, Party senderParty, Party aiderParty, HardcodeB2aTupleConfig config) {
        super(HardcodeB2aTuplePtoDesc.getInstance(), receiverRpc, senderParty, config);
    }
