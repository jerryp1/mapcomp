 ...
 * @date 2022/06/13
 */
public abstract class AbstractZpVoleSender extends AbstractSecureTwoPartyPto implements ZpVoleSender {
    /**
     * ZP-VOLE配置项
     */
    ...
    protected AbstractZpVoleSender(PtoDesc ptoDesc, Rpc senderRpc, Party receiverParty, ZpVoleConfig config) {
