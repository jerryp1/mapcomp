...
import edu.alibaba.mpc4j.s2pc.pcg.ot.cot.spcot.mspcot.MspCotSender;
...
public class Ywl20NcCotSender extends AbstractNcCotSender {
    ...
    public void setTaskId(long taskId) {
        ...
        rcotSender.setTaskId(taskIdPrf.getLong(0, taskIdBytes, Long.MAX_VALUE));
    ...
    public void init(byte[] delta, int num) throws MpcAbortException {
        ...
        stopWatch.start();
        // 得到初始化阶段的k个COT
        CotSenderOutput vInitCotSenderOutput = rcotSender.send(initK);
        stopWatch.stop();
