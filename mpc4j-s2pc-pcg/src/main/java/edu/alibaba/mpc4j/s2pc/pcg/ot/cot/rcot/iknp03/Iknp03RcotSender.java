...
import edu.alibaba.mpc4j.s2pc.pcg.ot.cot.rcot.iknp03.Iknp03RcotPtoDesc.PtoStep;

/**
 * IKNP03-半诚实安全RCOT协议发送方。
 *
 * @author Weiran Liu
 * @date 2020/05/27
 */
public class Iknp03RcotSender extends AbstractRcotSender {
    /**
     * 基础OT协议接收方
     */
    ...
    public Iknp03RcotSender(Rpc senderRpc, Party receiverParty, Iknp03RcotConfig config) {
        super(Iknp03RcotPtoDesc.getInstance(), senderRpc, receiverParty, config);
