...
public class Liu22BitmapReceiver extends AbstractBitmapParty {
    ...
    public SecureBitmapContainer fromOwnRoaringBitmap(RoaringBitmap roaringBitmap) {
        ...
        BcSquareVector BcSquareVector = bcReceiver.setOwnInputs(shares, Integer.MAX_VALUE);
        return new SecureBitmapContainer(BcSquareVector);
    }

    @Override
    public SecureBitmapContainer fromOtherRoaringBitmap() {
        BcSquareVector BcSquareVector = bcReceiver.setOtherInputs(1, Integer.MAX_VALUE);
        return new SecureBitmapContainer(BcSquareVector);
    }
    ...
    public long[][] revealOwn(SecureBitmapContainer secureBitmapContainer) {
        ...
        byte[] outputs = bcReceiver.getOwnOutputs(secureBitmapContainer.getVector());
