...
import edu.alibaba.mpc4j.s2pc.pjc.main.pid.PidMain4Batch;
import edu.alibaba.mpc4j.s2pc.pjc.main.pmap.PmapMain4Batch;
...
public class PjcMain4Dir {
    private static final Logger LOGGER = LoggerFactory.getLogger(PjcMain4Dir.class);
    /**
    ...
    public static void main(String[] args) throws Exception {
        ...
        for(String fileName : allFileName){
            ...
            switch (ptoType) {
                case PidMain4Batch.PTO_TYPE_NAME:
                    PidMain4Batch pidMain4Batch = new PidMain4Batch(properties);
                    pidMain4Batch.runNetty(ownRpc);
                    break;
                case PmapMain4Batch.PTO_TYPE_NAME:
                    PmapMain4Batch pmapMain4Batch = new PmapMain4Batch(properties);
                    pmapMain4Batch.runNetty(ownRpc);
                    break;
                default:
