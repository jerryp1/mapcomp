 ...
 * @date 2022/11/24
 */
class OrBitmapSenderThread extends Thread {
    /**
     * bitmap发送方
     */
    ...
    OrBitmapSenderThread(BitmapParty sender, RoaringBitmap x, boolean xPublic, RoaringBitmap y, boolean yPublic, int maxNum) {
        // 当y非public时应为null
