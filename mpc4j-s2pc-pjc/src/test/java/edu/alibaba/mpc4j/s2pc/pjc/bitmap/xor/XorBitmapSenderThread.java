 ...
 * @date 2022/11/24
 */
class XorBitmapSenderThread extends Thread {
    /**
     * bitmap发送方
     */
    ...
    XorBitmapSenderThread(BitmapParty sender, RoaringBitmap x, boolean xPublic, RoaringBitmap y, boolean yPublic, int maxNum) {
        // 当y非public时应为null
    ...
    public void run() {
        try {
            ...
            SecureBitmapContainer z0 = sender.xor(x0, y0);
