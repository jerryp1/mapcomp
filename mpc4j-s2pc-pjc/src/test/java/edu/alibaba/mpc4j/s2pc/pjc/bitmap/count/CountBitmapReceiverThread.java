 ...
 * @date 2022/11/24
 */
class CountBitmapReceiverThread extends Thread {
    /**
     * bitmap接收方
     */
    ...
    CountBitmapReceiverThread(BitmapParty receiver, RoaringBitmap x, boolean xPublic, RoaringBitmap y, boolean yPublic, int maxNum) {
        // 当x非public时应为null
