...
public class Psz14OptOprfSender extends AbstractOprfSender {
    /**
     * 核LOT协议接收方
     */
    ...
    public Psz14OptOprfSender(Rpc senderRpc, Party receiverParty, Psz14OptOprfConfig config) {
        super(Psz14OptOprfPtoDesc.getInstance(), senderRpc, receiverParty, config);
    ...
    public void init(int maxBatchSize, int maxPrfNum) throws MpcAbortException {
        ...
        lcotSender.init(l, maxBatchSize);
        stopWatch.stop();
    ...
    public OprfSenderOutput oprf(int batchSize) throws MpcAbortException {
        ...
        stopWatch.start();
        // 执行COT协议
        LcotSenderOutput lcotSenderOutput = lcotSender.send(batchSize);
        Psz14OptOprfSenderOutput psz14OptOprfSenderOutput = new Psz14OptOprfSenderOutput(envType, batchSize, l, lcotSenderOutput);
        stopWatch.stop();
        ...
        return psz14OptOprfSenderOutput;
    }
}
