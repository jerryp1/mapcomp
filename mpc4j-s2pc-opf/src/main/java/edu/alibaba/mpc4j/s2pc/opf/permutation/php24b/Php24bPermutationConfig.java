 ...
 * @date 2023/5/22
 */
public class Php24bPermutationConfig extends AbstractMultiPartyPtoConfig implements PermutationConfig {
    /**
     * Osn config.
     */
    ...
    private Php24bPermutationConfig(Builder builder) {
    ...
    public PermutationTypes getPtoType() {
        return PermutationTypes.PHP24B;
    }
    ...
    public static class Builder implements org.apache.commons.lang3.builder.Builder<Php24bPermutationConfig> {
        /**
         * Osn config.
         */
        private final OsnConfig osnConfig;
        ...
        @Override
        public Php24bPermutationConfig build() {
            return new Php24bPermutationConfig(this);
        }
    }
}
