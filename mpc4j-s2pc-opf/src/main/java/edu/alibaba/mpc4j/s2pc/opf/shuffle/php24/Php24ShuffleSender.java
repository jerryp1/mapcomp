...
/**
 * Php+24 shuffle sender.
 *
 * @author Li Peng
 * @date 2023/5/22
 */
public class Php24ShuffleSender extends AbstractShuffleParty {
    /**
     * Osn sender.
     */
    ...
    public Php24ShuffleSender(Rpc senderRpc, Party receiverParty, Php24ShuffleConfig config) {
        super(Php24ShufflePtoDesc.getInstance(), senderRpc, receiverParty, config);
