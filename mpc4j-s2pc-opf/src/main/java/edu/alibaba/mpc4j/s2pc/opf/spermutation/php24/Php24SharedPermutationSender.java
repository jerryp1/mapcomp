...
public class Php24SharedPermutationSender extends AbstractSharedPermutationParty {
    ...
    public Php24SharedPermutationSender(Rpc senderRpc, Party receiverParty, Php24SharedPermutationConfig config) {
        super(Php24SharedPermutationPtoDesc.getInstance(), senderRpc, receiverParty, config);
