...
import edu.alibaba.mpc4j.s2pc.opf.spermutation.php24.Php24SharedPermutationPtoDesc.PtoStep;
 ...
 * @date 2023/5/25
 */
public class Php24SharedPermutationReceiver extends AbstractSharedPermutationParty {
    /**
     * Shuffle receiver.
     */
    ...
    public Php24SharedPermutationReceiver(Rpc receiverRpc, Party senderParty, Php24SharedPermutationConfig config) {
        super(Php24SharedPermutationPtoDesc.getInstance(), receiverRpc, senderParty, config);
