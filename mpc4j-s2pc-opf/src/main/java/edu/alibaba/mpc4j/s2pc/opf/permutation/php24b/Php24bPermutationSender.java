 ...
 *
 */
public class Php24bPermutationSender extends AbstractPermutationSender {
    /**
     * Osn sender.
     */
    ...
    public Php24bPermutationSender(Rpc senderRpc, Party receiverParty, Php24bPermutationConfig config) {
        super(Php24bPermutationPtoDesc.getInstance(), senderRpc, receiverParty, config);
        ...
        addMultipleSubPtos(osnSender, osnReceiver, zlcSender, z2cReceiver, a2bSender, b2aSender);
    }
