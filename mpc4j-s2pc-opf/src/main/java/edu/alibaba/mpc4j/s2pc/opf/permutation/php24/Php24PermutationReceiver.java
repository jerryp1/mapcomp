 ...
 *
 */
public class Php24PermutationReceiver extends AbstractPermutationReceiver {
    /**
     * Osn receciver.
     */
    ...
    public Php24PermutationReceiver(Rpc receiverRpc, Party senderParty, Php24PermutationConfig config) {
        super(Php24PermutationPtoDesc.getInstance(), receiverRpc, senderParty, config);
    ...
    public Vector<byte[]> permute(Vector<byte[]> perm, int inputByteL) throws MpcAbortException {
        ...
        // osn2
        OsnPartyOutput osnPartyOutput2 = osnReceiver.osn(reversePerm, inputByteL);
