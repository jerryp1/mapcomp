...
public class Prty19FastMpOprfSender extends AbstractMpOprfSender {
    ...
    public MpOprfSenderOutput oprf(int batchSize) throws MpcAbortException {
        ...
        // 读取矩阵
        Prty19FastMpOprfSenderOutput senderOutput = new Prty19FastMpOprfSenderOutput(envType, batchSize, hashBinKeys, binNum, binSize, cotReceiverOutput.getRbArray(), BinaryUtils.binaryToByteArray(s), storagePayload.toArray(new byte[0][]), okvsType, okvsKeys, parallel);
        okvsKeys = null;
        s = null;
        stopWatch.stop();
