package edu.alibaba.mpc4j.s2pc.opf.prefixagg.prefixsum.php24;
...
/**
 * Php+24 prefix sum Config.
 *
 * @author Li Peng
 * @date 2023/10/30
 */
public class Php24PrefixSumConfig extends AbstractMultiPartyPtoConfig implements PrefixSumConfig {
    /**
     * Z2 circuit config.
     */
    ...
    private Php24PrefixSumConfig(Builder builder) {
    ...
    public static class Builder implements org.apache.commons.lang3.builder.Builder<Php24PrefixSumConfig> {
        /**
         * Z2 circuit config.
         */
        private final Z2cConfig z2cConfig;
        ...
        @Override
        public Php24PrefixSumConfig build() {
            return new Php24PrefixSumConfig(this);
        }
