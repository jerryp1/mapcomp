...
/**
 * Php+24b un-shuffle receiver.
 *
 * @author Li Peng
 * @date 2023/5/26
 */
public class Php24bShuffleReceiver extends AbstractShuffleParty {
    /**
     * Osn sender.
     */
    ...
    public Php24bShuffleReceiver(Rpc receiverRpc, Party senderParty, Php24bShuffleConfig config) {
        super(Php24bShufflePtoDesc.getInstance(), receiverRpc, senderParty, config);
