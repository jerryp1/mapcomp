 ...
 * @date 2023/4/4
 */
public class Zl64LongDatabase implements Database {
    /**
     * display data rows
     */
     ...
     * @return a database.
     */
    public static Zl64LongDatabase create(int l, long[] data) {
        Zl64LongDatabase database = new Zl64LongDatabase(l);
     ...
     * @return a database.
     */
    public static Zl64LongDatabase createRandom(int l, int rows, SecureRandom secureRandom) {
        Zl64LongDatabase database = new Zl64LongDatabase(l);
        MathPreconditions.checkPositive("rows", rows);
     ...
     * @return a database.
     */
    public static Zl64LongDatabase create(EnvType envType, boolean parallel, BitVector... bitVectors) {
    ...
    public Database split(int splitRows) {
        ...
        data = remainData;
        return Zl64LongDatabase.create(l, subData);
    }
    ...
    public void merge(Database other) {
        Zl64LongDatabase that = (Zl64LongDatabase) other;
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof Zl64LongDatabase) {
            Zl64LongDatabase that = (Zl64LongDatabase) obj;
