 ...
 * @date 2023/9/20
 */
public class ShuffleSingleKeywordCpPirClient<T> extends AbstractSingleKeywordCpPirClient<T> {
    /**
     * sq-OPRF receiver
     */
    ...
    public ShuffleSingleKeywordCpPirClient(Rpc clientRpc, Party serverParty, ShuffleSingleKeywordCpPirConfig config) {
        super(ShuffleSingleKeywordCpPirDesc.getInstance(), clientRpc, serverParty, config);
