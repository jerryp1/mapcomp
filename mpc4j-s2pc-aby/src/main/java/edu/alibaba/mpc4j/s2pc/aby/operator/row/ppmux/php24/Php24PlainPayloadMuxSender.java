 ...
 * @date 2023/11/5
 */
public class Php24PlainPayloadMuxSender extends AbstractPlainPayloadMuxParty {
    /**
     * COT sender
     */
    ...
    public Php24PlainPayloadMuxSender(Rpc senderRpc, Party receiverParty, Php24PlainPayloadMuxConfig config) {
        super(Php24PlainPayloadMuxPtoDesc.getInstance(), senderRpc, receiverParty, config);
