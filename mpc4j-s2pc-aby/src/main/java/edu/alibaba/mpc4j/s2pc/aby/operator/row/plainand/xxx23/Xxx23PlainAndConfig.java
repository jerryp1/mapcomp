 ...
 * @date 2023/11/8
 */
public class Xxx23PlainAndConfig extends AbstractMultiPartyPtoConfig implements PlainAndConfig {
    /**
     * COT config
     */
    ...
    private Xxx23PlainAndConfig(Builder builder) {
    ...
    public PlainAndType getPtoType() {
        return PlainAndType.Xxx23;
    }

    public static class Builder implements org.apache.commons.lang3.builder.Builder<Xxx23PlainAndConfig> {
        /**
         * COT config
         */
        ...
        @Override
        public Xxx23PlainAndConfig build() {
            return new Xxx23PlainAndConfig(this);
        }
    }
}
