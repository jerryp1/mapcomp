 ...
 * @date 2023/11/8
 */
public class Xxx23PlainAndReceiver extends AbstractPlainAndParty {
    /**
     * COT receiver
     */
    ...
    public Xxx23PlainAndReceiver(Rpc receiverRpc, Party senderParty, Xxx23PlainAndConfig config) {
        super(Xxx23PlainAndPtoDesc.getInstance(), receiverRpc, senderParty, config);
