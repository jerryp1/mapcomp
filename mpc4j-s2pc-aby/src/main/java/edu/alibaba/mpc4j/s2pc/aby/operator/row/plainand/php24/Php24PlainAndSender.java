 ...
 * @date 2023/11/8
 */
public class Php24PlainAndSender extends AbstractPlainAndParty {
    /**
     * COT sender
     */
    ...
    public Php24PlainAndSender(Rpc senderRpc, Party receiverParty, Php24PlainAndConfig config) {
        super(Php24PlainAndPtoDesc.getInstance(), senderRpc, receiverParty, config);
