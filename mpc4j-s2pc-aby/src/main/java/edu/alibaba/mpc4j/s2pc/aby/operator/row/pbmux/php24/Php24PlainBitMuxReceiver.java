 ...
 * @date 2023/11/5
 */
public class Php24PlainBitMuxReceiver extends AbstractPlainBitMuxParty {
    /**
     * COT receiver
     */
    ...
    public Php24PlainBitMuxReceiver(Rpc receiverRpc, Party senderParty, Php24PlainBitMuxConfig config) {
        super(Php24PlainBitMuxPtoDesc.getInstance(), receiverRpc, senderParty, config);
