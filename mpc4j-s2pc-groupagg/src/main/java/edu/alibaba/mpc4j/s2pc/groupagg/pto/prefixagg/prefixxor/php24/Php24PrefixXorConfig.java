...
public class Php24PrefixXorConfig extends AbstractMultiPartyPtoConfig implements PrefixXorConfig {
    ...
    private Php24PrefixXorConfig(Builder builder) {
    ...
    @Override
    public PrefixXorTypes getPtoType() {
        return PrefixXorTypes.PHP24;
    }
    ...
    public static class Builder implements org.apache.commons.lang3.builder.Builder<Php24PrefixXorConfig> {
        /**
         * Z2 circuit config.
         */
        private final Z2cConfig z2cConfig;
        ...
        @Override
        public Php24PrefixXorConfig build() {
            return new Php24PrefixXorConfig(this);
        }
