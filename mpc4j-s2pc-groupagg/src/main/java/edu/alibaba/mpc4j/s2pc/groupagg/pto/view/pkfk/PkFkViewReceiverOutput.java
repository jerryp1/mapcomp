...
public class PkFkViewReceiverOutput {
    ...
    public PkFkViewReceiverOutput(byte[][] inputKey, BitVector[] inputPayload, int[] pi, int[] sigma, SquareZ2Vector[] shareData, BitVector[] selfData, SquareZ2Vector equalFlag){
