...
public class Php24PrefixSumSender extends AbstractPrefixSumAggregator {
    ...
    public Php24PrefixSumSender(Rpc senderRpc, Party receiverParty, Php24PrefixSumConfig config) {
        super(Php24PrefixSumPtoDesc.getInstance(), senderRpc, receiverParty, config);
