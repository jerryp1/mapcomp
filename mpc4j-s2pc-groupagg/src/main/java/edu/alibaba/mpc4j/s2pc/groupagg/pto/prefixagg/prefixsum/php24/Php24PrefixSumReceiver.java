...
import edu.alibaba.mpc4j.s2pc.groupagg.pto.prefixagg.prefixsum.AbstractPrefixSumAggregator;
 ...
 * @date 2023/5/30
 */
public class Php24PrefixSumReceiver extends AbstractPrefixSumAggregator {

    public Php24PrefixSumReceiver(Rpc receiverRpc, Party senderParty, Php24PrefixSumConfig config) {
        super(Php24PrefixSumPtoDesc.getInstance(), receiverRpc, senderParty, config);
