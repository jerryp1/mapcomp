 ...
 *
 */
public class Php24PrefixXorReceiver extends AbstractPrefixXorAggregator {

    public Php24PrefixXorReceiver(Rpc receiverRpc, Party senderParty, Php24PrefixXorConfig config) {
        super(Php24PrefixXorPtoDesc.getInstance(), receiverRpc, senderParty, config);
        ...
        pbMuxParty = PlainBitMuxFactory.createReceiver(receiverRpc, senderParty, config.getPlainBitMuxConfig());
