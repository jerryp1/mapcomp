...
public class OptimizedSortingGroupAggReceiver extends AbstractGroupAggParty {
    ...
    public GroupAggOut groupAgg(String[] groupAttr, final long[] aggAttr,
        ...
        stopWatch.stop();
        long transposeT = stopWatch.getTime(TimeUnit.MILLISECONDS);
        stopWatch.reset();
        // ### test
...
//        ZlVector zlVector = zlcReceiver.revealOwn(receiverAggAs);
        ...
        stopWatch.reset();
        LOGGER.info("osn1T:{},psorterT:{},permute1T:{},permute2T:{},mergeGroupT:{},b2aT:{},aggT:{}",osn1T,psorterT,permute1T,permute2T,mergeGroupT,transposeT,aggT);
        return groupAggOut;
    }
