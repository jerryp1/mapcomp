...
/**
 * Advanced Heavy Hitter client with Local Differential Privacy based on Hot HeavyGuardian.
 *
 * @author Weiran Liu
 * @date 2023/1/5
 */
public class AdvHhgLdpHhClient extends AbstractHgLdpHhClient implements HhgLdpHhClient {
    /**
    ...
    public AdvHhgLdpHhClient(HhgLdpHhClientConfig clientConfig) {
        super(clientConfig);
    ...
    protected String userMechanism3(int bucketIndex, Map<String, Double> currentBudget, String item, Random random) {
        ...
        if (weakestCurrentCount <= 1.0) {
            ...
            // return BOT
            return LdpHhFactory.BOT_PREFIX + bucketIndex;
        }
    }
