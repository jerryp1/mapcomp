...
public class Scalar implements Serializable {
    ...
    public Scalar multiplyAndAdd(Scalar b, Scalar c) {
        long a0 = 0x1FFFFF & ByteEccUtils.decodeLong24(this.s, 0);
        long a1 = 0x1FFFFF & (ByteEccUtils.decodeLong32(this.s, 2) >> 5);
        long a2 = 0x1FFFFF & (ByteEccUtils.decodeLong24(this.s, 5) >> 2);
        long a3 = 0x1FFFFF & (ByteEccUtils.decodeLong32(this.s, 7) >> 7);
        long a4 = 0x1FFFFF & (ByteEccUtils.decodeLong32(this.s, 10) >> 4);
        long a5 = 0x1FFFFF & (ByteEccUtils.decodeLong24(this.s, 13) >> 1);
        long a6 = 0x1FFFFF & (ByteEccUtils.decodeLong32(this.s, 15) >> 6);
        long a7 = 0x1FFFFF & (ByteEccUtils.decodeLong24(this.s, 18) >> 3);
        long a8 = 0x1FFFFF & ByteEccUtils.decodeLong24(this.s, 21);
        long a9 = 0x1FFFFF & (ByteEccUtils.decodeLong32(this.s, 23) >> 5);
        long a10 = 0x1FFFFF & (ByteEccUtils.decodeLong24(this.s, 26) >> 2);
        long a11 = (ByteEccUtils.decodeLong32(this.s, 28) >> 7);
