...
public final class Constants {
     ...
     */
    static final FieldElement ONE_MINUS_D_SQ = FieldElement.ONE.sub(EDWARDS_D.sqr());

    /**
     * $= (d - 1)^2$, where $d$ is the Edwards curve parameter.
     */
    static final FieldElement D_MINUS_ONE_SQ = EDWARDS_D.sub(FieldElement.ONE).sqr();
