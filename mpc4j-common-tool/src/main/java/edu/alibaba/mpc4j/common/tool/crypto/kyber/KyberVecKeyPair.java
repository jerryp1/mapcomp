...
public class KyberVecKeyPair {
     ...
     * Default Constructor
     */
    public KyberVecKeyPair() {

    }

    private void setKeyPair(short[][] publicKeyVec, short[][] privateKeyVec, byte[] publicKeyGenerator) {
        this.publicKeyVec = publicKeyVec;
     ...
     */
    public void setPublicKeyVec(short[][] publicKeyVec) {
        this.publicKeyVec = publicKeyVec;
    }
     ...
     */
    public void setPublicKeyGenerator(byte[] publicKeyGenerator) {
        this.publicKeyGenerator = publicKeyGenerator;
    }
     ...
     */
    public void setPrivateKeyVec(short[][] privateKeyVec) {
        this.privateKeyVec = privateKeyVec;
    }
