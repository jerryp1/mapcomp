...
class EklundhBitMatrix extends AbstractBitMatrix {
    ...
    EklundhBitMatrix(int rows, int columns) {
        super(rows, columns);
    ...
    public BitMatrix transpose() {
        ...
        EklundhBitMatrix b = new EklundhBitMatrix(columns, rows);
        // 迭代调用转置函数，完成转置
     ...
     */
    private void eklundhTranspose(EklundhBitMatrix a, EklundhBitMatrix b,
